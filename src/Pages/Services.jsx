    ...
    <section id="services" className="-scroll-mt-24 px-6 py-8">
      ...
      <div className="flex gap-25 flex-wrap justify-center p-6 text-center">
        {serviceData.map((s, index) => (
          <div
            key={index}
            className="card group border-2 border-[#D1D9E0] dark:border-amber-600 w-100 h-100 p-6 shadow-md shadow-[rgba(0,0,0,0.5)] dark:shadow-[rgba(255,165,0,0.5)] rounded-3xl hover:-translate-y-3 duration-300 transition-all"
          >
            <motion.div
            ...
            <motion.p
              ...
              initial="hidden"
              whileInView="show"
              className="text-sm text-gray-500 dark:text-[#ffde01] italic mb-2"
            >
              {s.question}
            </motion.p>
            <motion.p
